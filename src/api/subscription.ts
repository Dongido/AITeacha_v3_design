...
export const verifyCouponCode = async ({couponCode, schoolCouponCode, userType}: {couponCode?: string, schoolCouponCode?: string, userType?: "teacher" | "school"}): Promise<any> => {
  try {
     const finalCoupon = couponCode || schoolCouponCode;
    const response = await apiClient.post(`/auth/verify/couponcode`, {

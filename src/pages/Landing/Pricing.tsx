  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="mt-12">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-5  mb-6">
          ...
          <div className="w-full md:w-60">
            ...
            <select
              ...
              className="w-full p-2 border border-gray-300 rounded-full text-gray-800 bg-white focus:outline-none focus:ring-2 focus:ring-purple-500"
            >
              <option value="month">Monthly</option>
              <option value="threeMonths">3 Months</option>
              <option value="year">Yearly</option>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mx-auto px-4 py-4">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-stretch lg:space-x-8 space-y-8 lg:space-y-0">
              <div className="border  rounded-2xl p-6 bg-gray-50   flex flex-col flex-1">
                <h3 className="text-lg font-semibold mb-4">AiTeacha Free</h3>
                <p className="text-2xl font-bold mb-2">
                  {prices.free[currency][billingCycle]}
                </p>
                ...
                <ul className="list-disc space-y-2 mb-6 flex-grow">
                  <strong>Save time, get resources...</strong>
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Unlimited use of our essential free tools</li>
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Generate tailored, high-quality resources</li>
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  ...
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Easily download and save your generated resources</li>
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />
                    Interact with Zyra, our AI Chat Assistant, built exclusively
                  ...
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />AI Image generation for educators and students</li>
                </ul>
                <Button
                  onClick={() => navigate("/auth/onboarding")}
                  className="w-full py-2 rounded-full text-primary border border-[#4a2fa3] text-white hover:bg-[#4a2fa3] hover:text-white transition mt-auto"
                >
                  Sign Up for Free
                </Button>
              </div>
              ...
              {/* AiTeacha Basic Card (visible only for NGN) */}
              {currency === "NGN" && (
                <div className="border  rounded-2xl p-6 bg-white   flex flex-col flex-1">
                  <h3 className="text-xl font-semibold mb-4 text-black">
                    AiTeacha Basic
                  </h3>
                  <p className="text-3xl font-bold mb-2">
                  ...
                  <IoCheckmark className="shrink-0" size={20} />
                    ...
                    <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Unlimited AI-generated images and labeled diagrams.</li>
                    <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />
                      Download and save all your generated resources for offline
                    ...
                    <li className="flex items-center gap-2 ">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} /> No Classroom Management</li>
                  </ul>
                  <Button
                    onClick={() => navigate("/auth/onboarding")}
                  className="w-full py-2 rounded-full text-primary border border-[#4a2fa3] text-white hover:bg-[#4a2fa3] hover:text-white transition mt-auto"
              ...
              <div className="border  rounded-2xl p-6 bg-gray-50   flex flex-col flex-1">
                ...
                <ul className="list-disc space-y-2 mb-6 flex-grow">
                  ...
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Unlock all 45 advanced, time-saving AI tools</li>
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Unlimited content generation as you need</li>
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />
                    Generate unlimited AI-powered slides, exportable directly to
                  ...
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Unlimited assignments for student evaluation needs</li>
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />
                    Unlimited student performance reports to track and enhance
                  ...
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Virtual Classroom access </li>
                  <li className="flex items-center gap-2">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Full Access to Computer-Based Tests (CBT)</li>
                </ul>
                <Button
                  onClick={() => navigate("/auth/onboarding")}
                  className="w-full py-2 rounded-full text-primary border border-[#4a2fa3] text-white hover:bg-[#4a2fa3] hover:text-white transition mt-auto"
            ...
            <div className="flex flex-col lg:flex-row justify-center items-stretch lg:space-x-8 space-y-8 lg:space-y-0 mx-auto">
              ...
              <div className="border  rounded-2xl p-6 bg-gray-50   flex flex-col flex-1">
                ...
                <ul className="list-disc  space-y-2 mb-6 flex-grow">
                  ...
                  <li className="flex items-center gap-2 border-b-2 border-dashed pb-2 border-gray-300">
                  {" "}
                  <IoCheckmark className="shrink-0" size={20} />Unlimited number of educators</li>
                  <li className="flex items-center gap-2 ">
                  {" "}

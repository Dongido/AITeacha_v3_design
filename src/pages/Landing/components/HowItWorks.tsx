...
const HowItWorks: React.FC = () => {
  return (
    <section
      className="pb-32 pt-8 w-full text-white text-center"
      style={{ background: "linear-gradient(180deg, #5C3CBB, #8071AE)" }}
    >
      <h4 className="text-sm uppercase font-medium mb-2 underline">
        How it works
      </h4>
      <h2 className="text-3xl font-semibold mb-10 px-1">

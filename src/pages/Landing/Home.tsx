...
const Home: React.FC = () => {
  const testimonials = [
    ...
    {
      message:
        "AiTeacha AI has revolutionized my classroom. The adaptive learning platforms and intelligent support systems create an unparalleled teaching environment. It's a game-changer for educators dedicated to student success.",
    ...
    {
      message:
        "AiTeacha is a teaching app that has an engaging and interactive experience for both educators and learners. They offer a dynamic platform for delivering educational content in a more accessible and often entertaining manner.",

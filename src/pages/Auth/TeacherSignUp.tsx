import { TeacherSignupForm } from "./components/teacher-signup";
    ...
    <div className="w-full h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center h-full overflow-y-auto bg-white ">
        <div className="w-full max-w-md p-4 ">
          <div className="md:hidden flex items-center justify-center gap-1 text-black text-2xl font-bold mb-4">
            <Link
              to="/"

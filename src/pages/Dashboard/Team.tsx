  ...
  return (
    <ToastProvider>
      <div className="p-2 md:p-[30px]  lg:w-[80vw] w-[90vw]">
        ...
        <div className="bg-white gap-2 my-8 rounded-2xl p-3 md:p-6">
          <label className="block test-sm font-semibold mb-1">Email</label>
          <div className="flex items-center flex-wrap bg-white gap-2">
          ...
          <Button
            ...
            disabled={inviteLoading}
            variant={"gradient"}
            className={`w-full md:w-auto px-4 py-3 rounded-full md:rounded-md ${
              inviteLoading ? "opacity-50 cursor-not-allowed" : ""
            }`}
            >
            {inviteLoading ? "Inviting..." : "Invite"}
        ...
        <div className="py-2 flex flex-wrap gap-3 md:justify-between mb-5 items-center justify-center">
          {/* search Teamates */}
            <Input
              type="text"
              placeholder="Search team by name"

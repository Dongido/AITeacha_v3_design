...
const Classrooms = () => {
  ...
  const { classrooms: studentClassrooms } = useSelector(
  ...
  return (
    <div className="mt-4 p-2 md:p-[30px] routes-scroll-area ">
      ...
      <div className="w-full md:px-5 lg:-ml-3 mt-[30px] transition-all duration-300">
        {/* Top Nav Tabs */}
...

        {
          ...
          <table className="min-w-full border-collapse">
            ...
            {/* Table Area */}
            <div className="mt-6 p-5 bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
              <div className=" inline-flex gap-2 pl-4 mb-4 pr-20 py-2 bg-[#EBEBEB] text-[#7C7B7B] rounded-md ">

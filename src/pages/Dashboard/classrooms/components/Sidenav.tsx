...
export function Sidenav({
  ...
  const currentClassroomId = classroomId || paramClassroomId;
              ...
              <div className="mt-2">
                ...
                <div className="flex">
                  <button
                    ...
                    onClick={() => {
                      navigate("/student/classrooms/outlines/intro", {
                        state: { fromIntroduction: true },
                      });
                    }}
                  >
                    Introduction
                  ...
                  {outlines.length > 0 ? (
                    outlines.map((outline, index) => (
                      <div
                        key={index}
                        onClick={() => {
                          handleSelectOutlineInternal(outline);
                          navigate(

...
// import { BookCheckIcon, Undo2 } from "lucide-react";
...
// import CallPopup from "../student/CallPopUp";
// import {
...
// import Participant from "../student/Particpant";
...
//           )}
//           <div>
//             <div className="text-left mt-10 mb-10 lg:px-5">
...
//             <div className="flex items-center pb-2 lg:px-5">
...
//                     <span>
//                       <h1 className="text-[#6200EE] font-semibold text-3xl">
//                         3/10
//                       </h1>
...
//                     <div
//                       key="main"
//                       className={`mt-5 border cursor-pointer px-4 py-3 rounded-lg inline-flex flex-col items-center ${
//                         selectedTool === null
//                           ? "bg-[#EFE6FD] rounded-full text-black"
//                           : ""
//                       }`}
//                       //   onClick={() => handleSelectToolInternal(null)}
//                     >
//                       <img src={Avatar} className="w-full h-32" alt="avatar" />
//                       Main Classroom
//                     </div>
...
//                           className={`flex flex-col gap-2 p-4 rounded-2xl cursor-pointer bg-white ${
...
//                               />
//                             ) : (
//                               <BookCheckIcon className="text-purple-500 w-16 h-16 rounded-lg bg-gray-100 flex items-center justify-center" />
//                             )}
//                           </div>
...
// import { Button } from "../../../components/ui/Button";
// import { TextArea } from "../../../components/ui/TextArea";
// import { BookAIcon, Undo2 } from "lucide-react";
// import { useDispatch, useSelector } from "react-redux";
// import {
//   createClassroomSuggestion,
//   fetchClassroomByIdThunk,
...
//             <div className="text-left mt-10 mb-10 lg:px-10">
//               <p className="text-black text-sm bg-gray-300 rounded-full px-4 py-2 inline-flex">
//                 End Date: Jan 25, 2026
//               </p>
//               <h2 className="text-xl font-semibold text-black">
...
// >
//   <div className="p-4">
//     <h3 className="text-xl font-semibold mb-2">Class Tools</h3>

//     {/* Main Classroom */}
//     <div
//       key="main"
//       className={`cursor-pointer border px-4 py-3 rounded-lg mb-2 ${
//         selectedTool === null
//           ? "bg-[#6200EE] rounded-full text-white"
//           : "hover:bg-gray-100"
//       }`}
//       onClick={() => {
...
//     <div className="max-h-60 overflow-y-auto bg-gray-100 p-2 rounded-md">
//       {tools.map((tool, index) => (
//         <div
//           key={index}
//           onClick={() => {
...
//                 <BookAIcon className="text-purple-500 w-6 h-6" />
//               </div>
//             )}
//           </div>
...
import { FiPlayCircle } from "react-icons/fi";
import StudentNavbar from "../../../components/layout/Student-Navbar";
import Participants from "../student/Particpant";
import Avatar from "../../../assets/img/0e846ab4-992d-48b3-a818-d62a7803bd8e 1.png";
            ...
            <div className="flex items-center justify-between flex-col">
              ...
              <div className="w-full lg:px-3">
                <div className="flex gap-6">
                  ...
                  <button
                    onClick={() => setViewState("classroom")}
                    className={`text-sm font-semibold pb-2 transition-all duration-200 ${
                      viewState === "classroom"
                        ? "text-[#5c3cbb] border-b-4 border-[#6200EE]"
                        : "text-gray-700 hover:text-[#6200EE]"
                    }`}
                  ...
                  >
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                      <DialogHeader>
                        <DialogTitle>Voice Session Settings</DialogTitle>
                        <DialogDescription>
                          Choose your preferred voice, language, and grade for
                          the AI.
                        </DialogDescription>
                      </DialogHeader>
              ...
              {viewState === "classroom" ? (
                <>
                  <div className="flex gap-10 w-full px-3 mt-5">
                    <div className="flex flex-col gap-5 bg-white rounded-2xl p-4 w-full shadow-sm">
                      <span className="">
                        <h1 className="text-4xl text-[#6200EE] fontt-bold">
                          3/10
                        </h1>
                  ...
                  <div className="w-full py-4 flex">
                    <button
                      key="main"
                      className={`border cursor-pointer py-3 rounded-lg px-5 ${
                        selectedTool === null
                          ? "bg-[#EFE6FD] rounded-full text-black"
                          : ""
                      }`}
                      //   onClick={() => handleSelectToolInternal(null)}
                    >
                      <img src={Avatar} alt="Zyra" className="w-28" />
                      <p>Main Classroom</p>
                    </button>
                    <div className="bg-gray-100 p-1 rounded-md flex">
                      {tools.map((tool, index) => (
                        <div
                          key={index}
                          //   onClick={() =>
                          //     handleSelectToolInternal(tool.tool_name)
                          //   }
                        ...
                        >
                          <div className="text-1xl bg-white rounded-2xl p-2 flex flex-col">
                            {tool.tool_thumbnail ? (
                              <img
                                src={
                                  tool.tool_thumbnail.startsWith("http")
                              ...
                              <BookAIcon className="text-[#6200EE] w-16 h-16 rounded-lg bg-gray-100 flex items-center justify-center" />
                            )}
                            <p className="mt-2">
                              {!isCollapsed && <span>{tool.tool_name}</span>}
                            </p>
                ...
                <SimulationDashboardPage
                  ...
                  outline_content={outlineContentString || ""}
                />
              ) : viewState === "participant" && <Participants /> ? (
                <div className="w-ful">
                  <Participants />
                </div>
              ) : viewState === "liveclass" ? (
                <div className="liveclass-div">
                  <div className="my-8 p-6 bg-white py-20 border border-purple-2 rounded-lg shadow-sm">
                    {classroom?.liveclassroomassessments &&
                    classroom.liveclassroomassessments.length > 0 ? (
                      <>
                        <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-8 mb-6 text-center">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-md sm:text-lg text-gray-6 max-w-prose mx-auto mt-5">
                          ...
                          Please check back later or join the live session if
                          it's ongoing.
                        </p>
                        {classroom?.meeting_url && (
                          <div className="mt-6">
                ...
                <div className="p-6 mt-6 w-full"></div>
              )}

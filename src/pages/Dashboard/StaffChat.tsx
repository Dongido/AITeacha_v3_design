...
import { CalendarDays, ChevronRight, Plus, UserRound } from "lucide-react";
...
const StaffChat = () => {
  ...
  return (
    <div className="md:mt-6 p-[30px] overflow-x-hidden">
      ...
      <button
        onClick={() => navigate(-1)}
        // variant="outline"
        className="flex items-center gap-2 font-semibold w-full sm:w-fit  text-gray-700"
      >
      ...
      <div className="flex w-full mt-12 mb-6 items-center justify-between flex-col sm:flex-row">
        ...
        <div>
          ...
          <p className="text-sm">Manage all chat topics</p>
        </div>
                ...
                {topic?.map((topicItem) =>
                  topicItem && topicItem.topic ? (
                    <>
                      <div
                        key={topicItem.id}
                        className=" flex items-center border-gray-200 rounded-2xl
       p-5 bg-white transition-all duration-200"
                      >
                          ...
                          <div className="flex items-center justify-between gap-3">
                            ...
                            <div>
                              <Link
                                ...
                                className="w-14 h-14 rounded-full bg-purple-100 flex
              items-center justify-center text-purple-700 font-bold text-lg "
                            ...
                            <div>
                              {/* Topic title */}
                              <h3 className="text-[15px] uppercase  font-semibold cursor-pointer m-0 p-0 ">
                                <Link
                                  to={`/dashboard/teacherChats/${topicItem.id}`}
                                  className=""
                                >

...
const TestView = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
    <div className="p-3 md:p-[25px] flex flex-col justify-center  bg-white rounded-2xl shadow-sm">
      ...
      <p className="text-gray-800 m-0 mt-3 font-semibold">Objective Score</p>
    </div>
    <div className="p-3 md:p-[25px] flex flex-col justify-center bg-white rounded-2xl shadow-sm">
      <h1 className="text-2xl font-bold text-gray-700">
  ...
  const answerDetails = fetchedTestDetails?.questions?.find(
    (ans: any) => ans.examinationquestion_id === q.examinationquestions_id
  );
  ...
  if (optionLetter === studentAnswer && studentAnswer === correctAnswer) {
    borderColor = "border-green-500";
    icon = <IoCheckbox className="text-green-600 w-5 h-5" />;
  } else if (optionLetter === studentAnswer && studentAnswer !== correctAnswer) {
    borderColor = "border-red-500";
    icon = <LiaTimesCircleSolid className="text-red-600 w-5 h-5" />;
  } else if (optionLetter === correctAnswer && studentAnswer !== correctAnswer) {
    borderColor = "border-green-500";
    icon = <IoCheckbox className="text-green-600 w-5 h-5" />;
  }
